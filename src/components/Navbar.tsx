    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/95 transition-colors">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight text-slate-900 dark:text-slate-100 leading-none font-mono">
        ...
        <nav className="flex items-center rounded-xl bg-slate-100 dark:bg-slate-800/80 p-1 text-sm font-medium">
          <button
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden md:inline">{copied ? 'Link kopieret!' : 'Del'}</span>
          </button>
